    ...
    def _log_info(self, log_dict, runner):
        ...
        if log_dict["mode"] == "train":
            ...
            fields.extend(
                [
                    ...
                    {
                        "field": "state.chartTrainLoss.series[0].data",
        ...
        if log_dict["mode"] == "val":
            ...
            for metric_name in g.evalMetrics:
                metric_values = [
                    metric_val[0][1] for metric_val in list(class_metrics[metric_name[1:]].values())
                ]
                    ...
                    [
                        {
                            ...
                            "payload": [[log_dict["epoch"], mean_metric]],
                            "append": True,
                        }
                    ]
                )
